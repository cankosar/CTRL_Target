...
void c_menu::load_presets(void){
	...
	*/
	...
	banks[i_general].id=			bankid_general;
	...
	*/
	...
	banks[i_tuner].id=				bankid_tuner;
	banks[i_tuner].status=			0;
	...
	*/
	...
	banks[i_lowshelf].id=				bankid_lowshelf;
	...
	*/
	...
	banks[i_lowmid].id=				bankid_lowmid;
	...
	*/
	...
	banks[i_highmid].id=			bankid_highmid;
	...
	*/
	...
	banks[i_highshelf].id=				bankid_highshelf;
	...
	*/
	...
	banks[i_chorus].id=				bankid_chorus;
	...
	*/
	...
	banks[i_overdrive].id=				bankid_overdrive;
	...
	*/
	...
	banks[i_reverb].id=				bankid_reverb;
	...
	*/
	...
	banks[i_tremolo].id=			bankid_tremolo;
	...
	*/
	...
	banks[i_rotary].id=				bankid_rotary;
	...
	*/
	...
	banks[i_flanger].id=			bankid_flanger;
	...
	*/
	...
	banks[i_autowah].id=				bankid_autowah;
